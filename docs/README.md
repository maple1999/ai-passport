...
| Wi-Fi | On-demand 2.4 GHz STA scan plus application-managed STA connections | `main/demo_wifi.c`, `main/vocabulary_client.c`, `main/asr_audio.c` | IELTS and Voice ASR credentials are provisioned over local USB and stored in NVS; antenna/RF performance remains unverified |
